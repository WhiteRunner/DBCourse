...
sa.ajax('/AccAdmin/fristOpenAdmin', function(res) {
    ...
    // 配置 
    sa_admin.title = "Admin Interface";
    sa_admin.logo = 'sa-frame/admin-logo.png'; // 设置logo图标地址 
...
}.bind(this), { msg: 'Loading login information', login_url: 'login.html' });
...
sa_admin.dropList = [ // 头像点击处可操作的选项
    ...
    // },
    {
        name: 'Logout',
        click: function() {
            layer.confirm('Logout?', function() {
                sa.ajax('/AccAdmin/doExit', function(res) {
                    layer.alert('Logout Success', function() {
