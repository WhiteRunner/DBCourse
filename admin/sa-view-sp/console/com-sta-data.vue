	...
	<el-row :gutter="14">
		<el-col :lg="4" :sm="8" :xs="24">
			<div class="sa-wnk">
				...
				<div class="sa-wnk-tv">
					<p class="sa-wnk-title">User Count</p>
		...
		<el-col :lg="4" :sm="8" :xs="24">
			<div class="sa-wnk">
				...
				<div class="sa-wnk-tv">
					<p class="sa-wnk-title">Goods Count</p>
		...
		<el-col :lg="4" :sm="8" :xs="24">
			<div class="sa-wnk">
				...
				<div class="sa-wnk-tv">
					<p class="sa-wnk-title">Order Count</p>
		...
		<el-col :lg="4" :sm="8" :xs="24">
			<div class="sa-wnk">
				...
				<div class="sa-wnk-tv">
					<p class="sa-wnk-title">Order Amount</p>
...
<script>
	module.exports = {
		...
		created() {
            const that=this
            sa.ajax('/User/cnt',function(res) {
				// console.log(res.data)
                that.setStaDataValue({
				    userCount: res.data
			    });
			...
			sa.ajax('/Orders/priceSum',function(res) {
                // console.log("-----------",res.data)
                that.setStaDataValue({
				    moneyCount: res.data,
			    });
            })
			sa.ajax('/Goods/cnt',function(res) {
                // console.log("-----------",res.data)
                that.setStaDataValue({
				    goodsCount: res.data,
			    });
